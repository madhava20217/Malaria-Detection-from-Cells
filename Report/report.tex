...
Finally, we created a GUI-based interface which uses trained models for inferencing the class of a cell image.
...
The role of augmentations is also clearer: with CNN models performing better than before using them.
